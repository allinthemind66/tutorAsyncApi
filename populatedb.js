...
function userCreate(first_name, last_name, email, password, cb) {
    userDetail = { first_name: first_name, last_name: last_name, email: email, password: password, created_at: Date.now() }
...
/**
 * The following functions are being called in the async series function
 */
